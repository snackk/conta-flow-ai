...
import { Check, ChevronDown, ChevronRight, FolderKanban, Mail, Plus, UserMinus, UserPlus } from 'lucide-react';
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Pode pertencer a vários projetos; escolha com qual quer trabalhar e geste os respetivos membros.</p>
        </div>
        {isAdmin && (
          <button
